...
print(DistPlotAnn2)
```
Figure 9. Disturbance chronology. Orange and blue bars are disturbance signal by type per year. Grey bars are releases binned by decade. Solid black line is a kernel density function. Dotted black line is the sample depth. Vertical dashed gray line indicates the year the sample depth falls to five cores. 
